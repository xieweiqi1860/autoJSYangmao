...
function swipeVideoIndexDirection(direction, swipeDelay) {
  ...
  if (direction == 'up') {
    swipe(halfDeviceWidth + random(0, 100), halfDeviceHeight - offset, halfDeviceWidth + random(-50, 50), halfDeviceHeight + offset + videoSwipeDistance / 2, swipeDelay)
  } else if (direction == 'down') {
    swipe(halfDeviceWidth - random(0, 100), halfDeviceHeight + offset + videoSwipeDistance / 2, halfDeviceWidth + random(-50, 50), halfDeviceHeight - offset - videoSwipeDistance / 2, swipeDelay)
  }
}
function runOver() {
  home()
