...
function randomSwipeIndexDirection(direction) {
  ...
  swipe(halfDeviceWidth - random(-100, 100), halfDeviceHeight + offset + (swipeDistance / 2) * direction, halfDeviceWidth + random(-100, 100), halfDeviceHeight + offset - (swipeDistance / 2) * direction, 500)
  //ToDo 1圈金币翻倍卡
}
//是否有签到提醒
...
function swipeVideo() {
  ...
  swipe(halfDeviceWidth + random(-100, 100), halfDeviceHeight + offset + videoSwipeDistance / 2, halfDeviceWidth + random(-100, 100), halfDeviceHeight + offset - videoSwipeDistance / 2, 500)
  sleep(1000)
}
